...
function WidgetReqPieChart(props) {
  const widget = _.merge({}, props.widget);
  const theme = useTheme();

  _.setWith(widget, 'mainChart.options.theme.monochrome.color', theme.palette.success.dark);
...
export default memo(WidgetReqPieChart);
