		...
		},
    {
			...
			mainChart: {
				...
				options: {
					...
					labels: ['Not enough data. Please create some requests']
				}
			}
		},
		{
			...
			mainChart: {
				...
				options: {
					...
					labels: ['Equipment', 'Home Office', 'Meals and Entertainment', 'Office Supplies', 'Travel', 'Other']
				}
			}
		},
		{
...
mock.onGet('/api/expensedao/widgets').reply(config => {
	return [200, projectDashboardAppDB.expenseDaoWidgets];
});
